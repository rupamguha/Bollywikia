...
var c=document.getElementById("mfesecure-ts-style");if(!c){jQueryTs('<style id="mfesecure-ts-style" type="text/css">.trustedsite-body-noscroll{ overflow:hidden !important; width:100% !important;}</style>').appendTo("head")
